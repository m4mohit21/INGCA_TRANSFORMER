...
def prepare_dibco_experiment(folder, val_set, test_set, patches_size, overlap_size,
                             patches_size_valid):
...
prepare_dibco_experiment(folder,validation_dataset, testing_dataset, p_size,
